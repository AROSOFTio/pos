...
export default function Suppliers({currency}:{currency:string}){
 ...
 return <div><PageHeading eyebrow="Procurement master" title="Suppliers" sub="Supplier contacts and exactly which products each supplier provides." action={<button onClick={show} className="rounded-xl bg-slate-900 text-white px-4 py-2.5 text-sm font-medium"><Plus size={16} className="inline mr-1"/>New Supplier</button>}/>
